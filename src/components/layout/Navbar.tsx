      ...
      <header className="sticky top-0 z-50 w-full bg-[#F1F5F9] shadow-sm px-6 lg:px-24">
        <div className="max-w-[1440px] mx-auto flex h-28 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Socials on logo side for mobile */}
            <div className="flex md:hidden items-center gap-3 text-[#1e3a8a] border-l border-slate-300 pl-4 py-1">
              <a href="#" className="hover:text-blue-500 transition-colors"><Facebook className="h-5 w-5" /></a>
              <a href="#" className="hover:text-pink-600 transition-colors"><Instagram className="h-5 w-5" /></a>

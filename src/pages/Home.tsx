          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <Button nativeButton={false} render={<Link to={service.link} />} className={cn("w-full mt-auto text-white rounded-full h-14 font-black uppercase tracking-widest text-xs shadow-lg transition-colors duration-200", service.buttonColor)}>
                  {service.buttonText}
                </Button>
                </div>
              </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="flex-1 space-y-10 text-white order-1 lg:order-2">
              ...
              <div className="flex flex-row gap-4 sm:gap-6 pt-4">
                <Button nativeButton={false} render={<Link to="/book">Book Appointment</Link>} size="lg" className="flex-1 sm:flex-none bg-white text-blue-500 hover:bg-slate-50 rounded-full px-8 sm:px-12 h-16 sm:h-20 text-sm sm:text-xl font-black uppercase tracking-widest shadow-xl transition-colors duration-200 border-none">
                  Book Appointment
                </Button>
                <Link to="/contact" className="flex-1 sm:flex-none inline-flex items-center justify-center border-2 border-white/40 text-white hover:bg-white/10 rounded-full px-8 sm:px-12 h-16 sm:h-20 text-sm sm:text-xl font-black uppercase tracking-widest transition-colors duration-200 text-center">
                  General Inquiry
                </Link>
              </div>
            </div>

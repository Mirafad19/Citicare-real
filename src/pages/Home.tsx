    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full min-h-[600px] lg:min-h-[700px] bg-slate-50 overflow-hidden">
        <div className="max-w-[1440px] mx-auto min-h-[600px] lg:min-h-[700px] flex flex-col lg:flex-row relative">
          ...
          {/* Left Side: Content */}
          <div className="w-full lg:w-1/2 min-h-[400px] lg:min-h-full flex items-center z-30 px-5 sm:px-6 lg:px-20 py-16 lg:py-24 bg-slate-50">
          ...
          <div className="absolute lg:relative right-0 top-0 w-full lg:w-1/2 h-full z-10">

        ...
        <div className="container mx-auto px-6 lg:px-24">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <motion.div 
              ...
              className="pt-4"
            >
              <Button nativeButton={false} render={<Link to="/book" />} size="lg" className="bg-[#1e3a8a] text-white hover:bg-[#1a3375] rounded-full px-16 h-20 text-xl font-black uppercase tracking-widest shadow-xl transition-colors duration-200">
                Book a Specialist
              </Button>
            </motion.div>
          </div>

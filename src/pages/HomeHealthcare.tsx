        ...
        <div className="container mx-auto px-6 lg:px-24 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Button nativeButton={false} render={<Link to="/book" />} size="lg" className="bg-white text-[#1e3a8a] hover:bg-emerald-50 rounded-full px-12 h-16 text-lg font-black uppercase tracking-widest transition-transform hover:scale-105 active:scale-95">
                Request Home Care
              </Button>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6 lg:px-24">
          <div className="bg-[#2E5AAB] rounded-[4rem] p-12 lg:p-24 text-center text-white relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
              <Button nativeButton={false} render={<Link to="/book" />} size="lg" className="bg-white text-[#1e3a8a] rounded-full px-12 h-20 text-xl font-black uppercase tracking-widest transition-transform hover:scale-105">
                Book Initial Visit
              </Button>

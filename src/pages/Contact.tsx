              ...
              {submitted ? (
                ...
                <div className="w-full">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                    ...
                    <Button type="submit" className="w-full rounded-full h-14 md:h-16 text-base md:text-lg font-bold uppercase tracking-wider group shadow-2xl shadow-primary/20 bg-[#005FA3] text-white hover:bg-[#004d80]" disabled={loading}>
                       {loading ? (
